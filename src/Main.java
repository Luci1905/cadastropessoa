...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Bem vindo ao sistema de cadastro de Pessoa Físicas e Juridicas");
                            ...
                            case "2":
                                ...
                                if (listaPj.size() > 0) {
                                    ...
                                    for (PessoaJuridica cadaPj : listaPj) {
                                        ...
                                        System.out.println("Endereço: " + cadaPj.endereco);
                                        System.out.println("Aperte ENTER para continuar");
                                        leitor.nextLine();// so para parar o sistema
